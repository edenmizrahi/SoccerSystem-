...
public class Keys {
    ...
    public static final UniqueKey<RfaNotificationsRecord> KEY_RFA_NOTIFICATIONS_PRIMARY = UniqueKeys0.KEY_RFA_NOTIFICATIONS_PRIMARY;
    ...
    public static final ForeignKey<EventsRecord, MatchesRecord> FK_EVENTS2_MATCHES = ForeignKeys0.FK_EVENTS2_MATCHES;
    ...
    public static final ForeignKey<FanNotificationRecord, MatchesRecord> FK_FAN_NOTIFICATION_MATCHES = ForeignKeys0.FK_FAN_NOTIFICATION_MATCHES;
    public static final ForeignKey<FanNotificationRecord, FansRecord> FK_FAN_NOTIFICATION_FANS = ForeignKeys0.FK_FAN_NOTIFICATION_FANS;
    ...
    public static final ForeignKey<RefereeNotificationRecord, MatchesRecord> FK_REFEREE_NOTIFICATION_MATCHES = ForeignKeys0.FK_REFEREE_NOTIFICATION_MATCHES;
    public static final ForeignKey<RefereeNotificationRecord, RefereesRecord> FK_REFEREE_NOTIFICATION_REFEREES = ForeignKeys0.FK_REFEREE_NOTIFICATION_REFEREES;
    ...
    public static final ForeignKey<RefereesMatchesRecord, MatchesRecord> FK__MATCHES = ForeignKeys0.FK__MATCHES;
    public static final ForeignKey<RefereesMatchesRecord, RefereesRecord> FK_REFEREES_MATCHES_REFEREES = ForeignKeys0.FK_REFEREES_MATCHES_REFEREES;
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<RfaNotificationsRecord> KEY_RFA_NOTIFICATIONS_PRIMARY = Internal.createUniqueKey(RfaNotifications.RFA_NOTIFICATIONS, "KEY_rfa_notifications_PRIMARY", new TableField[] { RfaNotifications.RFA_NOTIFICATIONS.TEAM_NAME, RfaNotifications.RFA_NOTIFICATIONS.NOTIFICATION_CONTENT }, true);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<EventsRecord, MatchesRecord> FK_EVENTS2_MATCHES = Internal.createForeignKey(Keys.KEY_MATCHES_PRIMARY, Events.EVENTS, "FK_events2_matches", new TableField[] { Events.EVENTS.MATCH_DATE, Events.EVENTS.HOME_TEAM_MATCH, Events.EVENTS.AWAY_TEAM_MATCH }, true);
        ...
        public static final ForeignKey<FanNotificationRecord, MatchesRecord> FK_FAN_NOTIFICATION_MATCHES = Internal.createForeignKey(Keys.KEY_MATCHES_PRIMARY, FanNotification.FAN_NOTIFICATION, "FK_fan-notification_matches", new TableField[] { FanNotification.FAN_NOTIFICATION.MATCH_DATE, FanNotification.FAN_NOTIFICATION.HOME_TEAM, FanNotification.FAN_NOTIFICATION.AWAY_TEAM }, true);
        public static final ForeignKey<FanNotificationRecord, FansRecord> FK_FAN_NOTIFICATION_FANS = Internal.createForeignKey(Keys.KEY_FANS_PRIMARY, FanNotification.FAN_NOTIFICATION, "FK_fan-notification_fans", new TableField[] { FanNotification.FAN_NOTIFICATION.USERNAME }, true);
        ...
        public static final ForeignKey<RefereeNotificationRecord, MatchesRecord> FK_REFEREE_NOTIFICATION_MATCHES = Internal.createForeignKey(Keys.KEY_MATCHES_PRIMARY, RefereeNotification.REFEREE_NOTIFICATION, "FK_referee_notification_matches", new TableField[] { RefereeNotification.REFEREE_NOTIFICATION.MATCH_DATE, RefereeNotification.REFEREE_NOTIFICATION.HOME_TEAM, RefereeNotification.REFEREE_NOTIFICATION.AWAY_TEAM }, true);
        public static final ForeignKey<RefereeNotificationRecord, RefereesRecord> FK_REFEREE_NOTIFICATION_REFEREES = Internal.createForeignKey(Keys.KEY_REFEREES_PRIMARY, RefereeNotification.REFEREE_NOTIFICATION, "FK_referee_notification_referees", new TableField[] { RefereeNotification.REFEREE_NOTIFICATION.REFEREE }, true);
        ...
        public static final ForeignKey<RefereesMatchesRecord, MatchesRecord> FK__MATCHES = Internal.createForeignKey(Keys.KEY_MATCHES_PRIMARY, RefereesMatches.REFEREES_MATCHES, "FK__matches", new TableField[] { RefereesMatches.REFEREES_MATCHES.MATCHE_DATE, RefereesMatches.REFEREES_MATCHES.HOME_TEAM, RefereesMatches.REFEREES_MATCHES.AWAY_TEAM }, true);
        public static final ForeignKey<RefereesMatchesRecord, RefereesRecord> FK_REFEREES_MATCHES_REFEREES = Internal.createForeignKey(Keys.KEY_REFEREES_PRIMARY, RefereesMatches.REFEREES_MATCHES, "FK_referees_matches_referees", new TableField[] { RefereesMatches.REFEREES_MATCHES.REFEREE }, true);
