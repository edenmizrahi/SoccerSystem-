...
public class User {
    ...
    public LinkedHashSet<PrivatePage> searchByLeague(String leagueName) throws Exception {
        ...
        //if fan- save the search
        if(this instanceof Fan){
            ((Fan)this).addToSearchHistory("Domain.League: "+leagueName);
        }
    ...
    public LinkedHashSet<PrivatePage> searchBySeason(int seasonYear) throws Exception {
        ...
        //if fan- save the search
        if(this instanceof Fan){
            ((Fan)this).addToSearchHistory("Domain.Season: "+seasonYear);
        }
    ...
    public LinkedHashSet<PrivatePage> searchByTeamName(String teamName) throws Exception {
        ...
        //if fan- save the search
        if(this instanceof Fan){
            ((Fan)this).addToSearchHistory("Domain.Team Name: "+teamName);
        }
    ...
    public TeamRole signInAsPlayer(String name, String phoneNumber, String email, String userName, String password, Date dateOfBirth){
        ...
        if(checkValidDetails(userName,password,phoneNumber,email)){
            ...
            LOG.info(String.format("%s - %s", userName, "sign in as Domain.Player"));
            return newPlayer;
        }
        return null;
    }
    ...
    public TeamRole signInAsCoach(String name, String phoneNumber, String email, String userName, String password,Date dateOfBirth){
        ...
        if(checkValidDetails(userName,password,phoneNumber,email)){
            ...
            system.removeUser(this);
            LOG.info(String.format("%s - %s", userName, "sign in as Domain.Coach"));
            return newCoach;
        }
        return null;
    }
    ...
    public boolean signInAsReferee(String name, String phoneNumber, String email, String userName, String password, String qualification){
        ...
        if(checkValidDetails(userName,password,phoneNumber)){
            Domain.Referee newRef= new Domain.Referee(system,name,phoneNumber,email,userName,password,qualification);
            system.removeUser(this);
...
*/
    ...
    public Fan signInAsFan(String name, String phoneNumber, String email, String userName, String password,  Date dateOfBirth){
        ...
        if(checkValidDetails(userName,password,phoneNumber,email)){
            ...
            system.removeUser(this);
            LOG.info(String.format("%s - %s", userName, "sign in as Domain.Fan"));
            return newFan;
        }
        return null;
    }
    ...
    public boolean signInAsSystemManager(String name, String phoneNumber, String email, String userName, String password){
        // first check valid details
        if(checkValidDetails(userName,password,phoneNumber)){
            Domain.SystemManager newSM= new Domain.SystemManager(system,name,phoneNumber,email,userName,password);
            system.removeUser(this);
    ...
    */
    ...
    private void writeToLOG(String message){
        if(this instanceof Fan){
            ...
            LOG.info(String.format("%s - %s", "Guest Domain.User", message));
        }
    }
}
