...
public class FanNotificationRecord extends UpdatableRecordImpl<FanNotificationRecord> implements Record6<LocalDateTime, String, String, String, Integer, Integer> {

    private static final long serialVersionUID = -1806513370;
    ...
    @Override
    public Row6<LocalDateTime, String, String, String, Integer, Integer> valuesRow() {
    ...
    @Override
    public FanNotificationRecord value6(Integer value) {
        setRead(value);
        return this;
    }

    @Override
    public FanNotificationRecord values(LocalDateTime value1, String value2, String value3, String value4, Integer value5, Integer value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FanNotificationRecord(LocalDateTime matchDate, String homeTeam, String awayTeam, String username, Integer eventId, Integer read) {
        super(FanNotification.FAN_NOTIFICATION);
