...
//Open team and wait for approval
    ...
    public void addTeamOwner(TeamOwner tO) throws Exception {
        if(tO!=null) {
            ...
            if(!tO.getTeams().contains(this)) {
                ...
                throw new Exception("Domain.TeamOwner is already in this team");
            }
        }
        else{
            throw new Exception("Domain.TeamOwner is null");
        }
    }
    // adi
    //TODO test
    public void removeTeamOwner(TeamOwner tO)throws Exception{
        if(tO!=null) {
            if (teamOwners.contains(tO)) {
                ...
                throw new Exception("Domain.TeamOwner doesn't exist in this team");
            }
        }
        else{
            throw new Exception("Domain.TeamOwner is null");
    ...
    public void removeTeamManager(TeamManager tM)throws Exception{
        if(tM!=null) {
            if (tM.equals(teamManager)) {
                ...
                throw new Exception("This Domain.TeamManager doesn't exist in this team");
            }
        }
        else{
            throw new Exception("Domain.TeamManager is null");
        }
    }
    //adi
    ...
    public void removeCoach(Coach coachToRemove)throws Exception{
        if(coachToRemove != null) {
            ...
            throw new Exception("Domain.Coach is null");
        }
    }
    //adi
    //TODO test
    ...
    public void addPlayer(Player p) throws Exception {
        ...
        if(!p.equals(null)) {
            ...
            throw new Exception("Domain.Player is null");
    ...
    public void removePlayer(Player p)throws Exception{
        if(players.contains(p)){
            ...
            throw new Exception("This Domain.Player doesn't exist in this team");
        }
    }
    //adi
    //TODO test
     ...
     * The function called only!!!! from Domain.Season\Domain.League while adding the team
