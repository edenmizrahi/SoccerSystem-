...
public class SeasonsRecord extends UpdatableRecordImpl<SeasonsRecord> implements Record4<LocalDate, String, String, Byte> {

    private static final long serialVersionUID = -1484321208;
    ...
    @Override
    public Row4<LocalDate, String, String, Byte> fieldsRow() {
        return (Row4) super.fieldsRow();
    }

    @Override
    public Row4<LocalDate, String, String, Byte> valuesRow() {
    ...
    @Override
    public SeasonsRecord value1(LocalDate value) {
        setYear(value);
        return this;
    }
    ...
    @Override
    public SeasonsRecord values(LocalDate value1, String value2, String value3, Byte value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SeasonsRecord(LocalDate year, String schedulingpolicy, String calculationpolicy, Byte currentSeason) {
        super(Seasons.SEASONS);
