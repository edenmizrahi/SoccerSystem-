...
public class EventsRecord extends UpdatableRecordImpl<EventsRecord> implements Record8<Integer, LocalDateTime, String, LocalDate, String, String, String, Integer> {

    private static final long serialVersionUID = 2025373283;
    ...
    @Override
    public Row8<Integer, LocalDateTime, String, LocalDate, String, String, String, Integer> valuesRow() {
    ...
    @Override
    public EventsRecord values(Integer value1, LocalDateTime value2, String value3, LocalDate value4, String value5, String value6, String value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EventsRecord(Integer eventId, LocalDateTime date, String referee, LocalDate matchDate, String homeTeamMatch, String awayTeamMatch, String name, Integer minuteInMatch) {
        super(Events.EVENTS);
