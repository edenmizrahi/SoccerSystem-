...
public class RefereesMatchesRecord extends UpdatableRecordImpl<RefereesMatchesRecord> implements Record4<LocalDate, String, String, String> {

    private static final long serialVersionUID = -1745723124;

    /**
     * Setter for <code>footballsystem_db.referees_matches.matche_date</code>.
     */
    public void setMatcheDate(LocalDate value) {
        set(0, value);
    }
     ...
     */
    public LocalDate getMatcheDate() {
    ...
    @Override
    public Record4<LocalDate, String, String, String> key() {
    ...
    @Override
    public RefereesMatchesRecord value1(LocalDate value) {
        setMatcheDate(value);
        return this;
    }
    ...
    @Override
    public RefereesMatchesRecord values(LocalDate value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RefereesMatchesRecord(LocalDate matcheDate, String homeTeam, String awayTeam, String referee) {
        super(RefereesMatches.REFEREES_MATCHES);
