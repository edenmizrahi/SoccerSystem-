...
public class AddAndRemoveTeamProperties {
    ...
    public void acceptRemoveAndReplaceCoach() throws Exception {
        ...
        LinkedList<TeamRole> teamRoles = teamManagementController.getAllTeamRolesThatArentCoachWithTeam();
    ...
    public void acceptAddPlayer() throws Exception {
        ...
        LinkedList<TeamRole> teamRoles = teamManagementController.getAllTeamRolesThatArentPlayerWithTeam();
