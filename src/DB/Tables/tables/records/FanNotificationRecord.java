...
public class FanNotificationRecord extends UpdatableRecordImpl<FanNotificationRecord> implements Record6<LocalDate, String, String, String, Integer, Byte> {

    private static final long serialVersionUID = 72651592;
    ...
    @Override
    public Record5<LocalDate, String, String, String, Integer> key() {
